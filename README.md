...
### 🚀 Projects
- 🤖 **WA Bot Multi-Feature** – WhatsApp bot with games, VIP system, prayer time auto-group lock, and more  
- 📱 **Simple Apps** – Mobile apps with professional UI/UX  
- 📦 **API-based Tools** – Fast, lightweight API tools for automation
